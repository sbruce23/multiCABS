function [gr] = gradient_single(yobs_tmp, Beta_temp, tau_temp, sigmasqalpha)
...
%
%   Input:
%       1) yobs_tmp - time series data within the group
%       2) tau_temp - smoothing parameters  
%       3) Beta_temp - current coefficients
%       4) sigmasqalpha - smoothing parameters for the constant in real
%       components
%       5) nbasis - number of basis function used
%   Main Outputs:
%       6) gr - gradients for optimization process
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Beta_2 = Beta_temp(:,(dimen + dimen*(dimen-1)/2 + 1): end);
