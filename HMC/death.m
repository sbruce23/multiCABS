...
%
%   Input:
%       1) ts - TxN matrix of time series data
...
for k = 1:nexp_prop
    ...
    if k==cut_del
        ...
        [Beta_mean, Beta_var, yobs_tmp]= postBeta(k, ts, tau_prop(:,k),xi_prop);
		...
		loglike_curr=0;
        for jj=j:j+1
            [Beta_mean, Beta_var, yobs_tmp]= postBeta(jj, ts, tau_curr_temp(:,jj), xi_curr_temp);
